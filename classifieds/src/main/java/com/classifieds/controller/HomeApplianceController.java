...
public class HomeApplianceController extends BaseController {
	...
	public ModelAndView getHomeAppliance(HttpServletRequest request,
		...
		mMap.put("searchResultList",
				homeAppService.fetchHomeApplianceResultforSubId(subId));
		mMap.put("categoryList", CategoryList.getKeyValueMap());
		mMap.put("subCategoryList",
				ReferenceConstants.HomeNeedsCategory.getAllCodes());
		mMap.put("homeNeedLeftMenu", new HomeNeedsLeftMenuInfo());
		mMap.put("selectSarchCriterias",
				"Refine your search using the criterias shown on the left side.");
	...
	public ModelAndView searchWithLeftMenu(
			HttpServletRequest request,
			@ModelAttribute("homeNeedLeftMenu") HomeNeedsLeftMenuInfo leftMenuInfo) {
		Map<String, Object> mMap = new HashMap<String, Object>();
